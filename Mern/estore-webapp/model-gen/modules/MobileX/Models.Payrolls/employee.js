...
let employeeSchema = new Schema(
  {
    ...
    joiningDate: { type: DateTime, required: false },
    leavingDate: { type: DateTime, required: false },
    isWorking: { type: Boolean, required: false },
    category: { type: String, enum: Object.values(empType), required: false },
    eMail: { type: String, required: false },
    dateOfBirth: { type: DateTime, required: false },
    adharNumber: { type: String, required: false },
    panNo: { type: String, required: false },
    otherIdDetails: { type: String, required: false },
